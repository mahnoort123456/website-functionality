...
function TrackShipment() {
  ...
  }, [router]); // Make sure to include `router` in dependencies as it is used inside the function
  ...
  }, [queryLabelId, handleSubmit]); // Add `handleSubmit` to the dependency array
